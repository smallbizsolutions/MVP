...
export default function Dashboard() {
      ...
      <>
        {parts.map((part, i) =>
          part.type === 'text' ? (
            ...
            // Updated Citation Style: White background, Emerald border/text
            <button
              key={i}
              onClick={() => handleCitationClick(part)}
              className="inline-flex items-center bg-white border border-[#059669] text-[#059669] hover:bg-emerald-50 px-2 py-1 rounded text-xs font-bold transition-colors mx-1 cursor-pointer shadow-sm"
            >
  ...
  return (
    <div className="fixed inset-0 flex bg-white text-slate-900 overflow-hidden">
      ...
      {/* SIDEBAR - Slate 900 with Emerald Accents */}
